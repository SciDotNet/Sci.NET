...
/// <summary>
/// Represents an operand with a long value.
/// </summary>
[PublicAPI]
...
public readonly struct InlineLongOperand : IInlineNumberOperand<long>, IValueEquatable<InlineLongOperand>
{
    /// <inheritdoc />
    ...
    /// <inheritdoc />
    public static bool operator ==(InlineLongOperand left, InlineLongOperand right)
    {
    ...
    public bool Equals(InlineLongOperand other)
    {
    ...
    {
        return obj is InlineLongOperand other && Equals(other);
    }

...
/// <summary>
/// Represents a MSIL method operand.
/// </summary>
...
[PublicAPI]
public readonly struct MsilMethodOperand : IMsilOperand, IValueEquatable<MsilMethodOperand>
{
    /// <inheritdoc />
    ...
    /// <inheritdoc />
    public static bool operator ==(MsilMethodOperand left, MsilMethodOperand right)
    {
    ...
    public bool Equals(MsilMethodOperand other)
    {
    ...
    {
        return obj is MsilMethodOperand other && Equals(other);
    }

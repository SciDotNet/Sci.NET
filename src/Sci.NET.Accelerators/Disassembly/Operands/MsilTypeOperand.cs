...
/// <summary>
/// Represents a MSIL type operand.
/// </summary>
[PublicAPI]
...
public readonly struct MsilTypeOperand : IMsilOperand, IValueEquatable<MsilTypeOperand>
{
    /// <inheritdoc />
    ...
    /// <inheritdoc />
    public static bool operator ==(MsilTypeOperand left, MsilTypeOperand right)
    {
    ...
    public bool Equals(MsilTypeOperand other)
    {
    ...
    {
        return obj is MsilTypeOperand other && Equals(other);
    }

...
public static class Image
{
    ...
    public static Tensor<byte> Load(string path)
    {
    ...
    public static void Save(Tensor<byte> tensor, string path)
    {
        ...
        using var image = SixLabors.ImageSharp.Image.LoadPixelData<Rgb24>(convertedMemory.AsSpan(), tensor.Shape[2], tensor.Shape[1]);

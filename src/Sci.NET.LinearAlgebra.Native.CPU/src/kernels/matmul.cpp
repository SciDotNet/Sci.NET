...
void CPU::Kernels::matmul_kernel_st_float32(const Storage::MemoryBlock *left,
    ...
    const auto output = Storage::alloc(left_dim_x * right_dim_y, number_type::float32);
...
void CPU::Kernels::matmul_kernel_st_float64(const Storage::MemoryBlock *left,
                                            const Storage::MemoryBlock *right,
                                            Storage::MemoryBlock **result,
                                            const int64_t left_dim_x,
                                            const int64_t left_dim_y,
                                            const int64_t right_dim_x,
                                            const int64_t right_dim_y) {
    const auto output = Storage::alloc(left_dim_x * right_dim_y, number_type::float64);
...
void CPU::Kernels::matmul_kernel_mt_float32(const Storage::MemoryBlock *left,
                                            const Storage::MemoryBlock *right,
                                            Storage::MemoryBlock **result,
                                            const int64_t left_dim_x,
                                            const int64_t left_dim_y,
...
void CPU::Kernels::matmul_kernel_mt_float64(const Storage::MemoryBlock *left,
                                            const Storage::MemoryBlock *right,
                                            Storage::MemoryBlock **result,
                                            const int64_t left_dim_x,
                                            const int64_t left_dim_y,
